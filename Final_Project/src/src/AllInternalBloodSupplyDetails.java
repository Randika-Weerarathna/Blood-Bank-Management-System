 ...
 * @author User
 */
public class AllInternalBloodSupplyDetails extends javax.swing.JFrame {

    /**
     * Creates new form DonerDetails
     */
    public AllInternalBloodSupplyDetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblnewDoner.setText("All IN Supply Details");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ISupplyID", "IRequestID", "Blood Group", "SuppliedAmount", "Date", "Status"
            }
        ) {
       ...
       try
        {
         ...
         String query ="select * from internalsupply ";
            ...
            while(rs.next()){
                ...
                String tbDate[] = {ISID,IRID,BloodGroup,amount,Date,Status};
