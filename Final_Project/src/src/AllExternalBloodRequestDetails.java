 ...
 * @author User
 */
public class AllExternalBloodRequestDetails extends javax.swing.JFrame {

    /**
     * Creates new form DonerDetails
     */
    public AllExternalBloodRequestDetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblnewDoner.setText("All EX Requested Details");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ERequestID", "Hospital Name", "Hospital Address", "Recomended By", "Date", "Blood Group", "Quantity"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Integer.class
            };
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        try
        {
         ...
         String query ="select * from externalrequests ";
            ...
            while(rs.next()){
                ...
                String Hadrs = rs.getString("HospitalAddress");
                ...
                String tbDate[] = {ERID,Hname,Hadrs,recby,Date,BloodGroup,amount};
