 ...
 * @author User
 */
public class InternalBloodRequest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbwno = new javax.swing.JComboBox<>();
        ...
        lblwardno.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        lblwardno.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblwardno.setText("WARD NUMBER");
        lblwardno.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 255, 255), 2));
        ...
        cbwno.setFont(new java.awt.Font("Segoe UI Symbol", 1, 14)); // NOI18N
        cbwno.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<<Select Ward No>>", "W-1", "W-2", "W-3", "W-4", "W-5", "W-6", "W-7", "W-8", "W-9", "W-10" }));
        cbwno.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 255, 255), 2));
        cbwno.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbwnoItemStateChanged(evt);
            }
        });
        ...
        cbbamount.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<<Select Quantity>>", "1", "2", "3", "4", "5", "6", "7", "8", "9", " " }));
                ...
                .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(paneladdLayout.createSequentialGroup()
                        ...
                        .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblrecby, javax.swing.GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE)
                        ...
                        .addGap(42, 42, 42)
                        .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtrecby, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                            .addComponent(txtreqid)
                            .addComponent(cbwno, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(90, 90, 90)
                        .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblreqdate, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(lblbamount, javax.swing.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)))
                        .addGap(42, 42, 42)
                        .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtreqdate, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
        ...
        paneladdLayout.setVerticalGroup(
            ...
            .addGroup(paneladdLayout.createSequentialGroup()
                ...
                .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtreqdate, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(25, 25, 25)
                .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(paneladdLayout.createSequentialGroup()
                        .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblwardno, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbwno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(26, 26, 26)
                        .addGroup(paneladdLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
         try
        {
         ...
         java.sql.ResultSet rs = st.executeQuery("select MAX(IRequestID) from internalrequests");
         rs.next();
         rs.getString("MAX(IRequestID)");
         
         if(rs.getString("MAX(IRequestID)")==null)
         {
             txtreqid.setText("IR-0001");
         }
         else
         {
         int ID = Integer.parseInt(rs.getString("MAX(IRequestID)").substring(3,rs.getString("MAX(IRequestID)").length()));
         ID++;
         txtreqid.setText("IR-" + String.format("%04d", ID));
         }
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        try
        {
            ...
            if(Ward == null)
            {
            JOptionPane.showMessageDialog(null,"Select The Ward No");
            ...
            JOptionPane.showMessageDialog(null,"Select The Quantity");
               ...
               query1 ="INSERT INTO internalrequests(IRequestID,WardNo,RecomendedBy,RDate,RBloodGroup,Quantity)"  + "VALUES('"+RID+"','"+Ward+"','"+Recomend+"','"+date+"','"+BloodGroup+"','"+Quantity+"')";
               st.executeUpdate(query1);
               txtreqid.setText("");
               cbwno.setSelectedIndex(0);
               txtrecby.setText("");
    ...
    private void cbwnoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbwnoItemStateChanged
      Ward= cbwno.getSelectedItem().toString();
        
    }//GEN-LAST:event_cbwnoItemStateChanged
    ...
    private javax.swing.JComboBox<String> cbwno;
    private javax.swing.JMenu externalrequest;
    private javax.swing.JMenu internalrequest;
